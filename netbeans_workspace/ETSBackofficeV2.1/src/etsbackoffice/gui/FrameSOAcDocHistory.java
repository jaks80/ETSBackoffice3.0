 ...
 * @author Yusuf
 */
public class FrameSOAcDocHistory extends javax.swing.JFrame {
    ...
    public FrameSOAcDocHistory(java.awt.Frame parent) {
        initComponents();
    ...
    private void searchAcDocByCriteria() {        
        ...
        this.acDocs = oAcDocBo.sOAcDocHistoryByCriteria(contType,contactableId,acDocType, from, to);
    ...
    private void searchAcDoc() {
        ...
        if (!acDocRef.isEmpty()) {
          //this.acDocs = oAcDocBo.findCompleteAcDocByRefNo(Integer.valueOf(acDocRef));
        } 
    ...
    private void strikeThroughRow(int row) {
        for (int i = 0; i < 7; i++) {
            tblInvoice.setValueAt("<html><strike>" + tblInvoice.getValueAt(0, i) + "</html></strike>", 0, i);
        }
    }
    ...
    private ActionListener radioCustomerListener = new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            busyIcon.setBusy(true);
            List cmbElement = new ArrayList();
            cmbElement = customerBo.customerNameList();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(etsbackoffice.ETSBackofficeApp.class).getContext().getResourceMap(FrameSOAcDocHistory.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(etsbackoffice.ETSBackofficeApp.class).getContext().getActionMap(FrameSOAcDocHistory.class, this);
        ...
        btnDeleteInvoice.setFont(resourceMap.getFont("btnDeleteInvoice.font")); // NOI18N
        btnDeleteInvoice.setText(resourceMap.getString("btnDeleteInvoice.text")); // NOI18N
        btnDeleteInvoice.setFocusable(false);
        btnDeleteInvoice.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btnDeleteInvoice.setName("btnDeleteInvoice"); // NOI18N
        ...
        txtAcDocRef.setFont(resourceMap.getFont("jLabel2.font")); // NOI18N
        ...
        cmbService.setFont(resourceMap.getFont("jLabel3.font")); // NOI18N
    ...
    private void btnCriteriaSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCriteriaSearchActionPerformed
        new Thread(new threadSearchInvoiceByCriteria()).start();
    ...
    private void btnVoidActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVoidActionPerformed
        new Thread(new threadVoidAcDoc()).start();;
    }//GEN-LAST:event_btnVoidActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        strikeThroughRow(tblInvoice.getSelectedRow());
    ...
    private void btnDeleteInvoiceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteInvoiceActionPerformed
       ...
       if(row!=-1){
        oAcDocBo.deleteOAcDoc(this.acDocs.get(row));
       }
  ...
  /*  public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new FrameSOAcDocHistory().setVisible(true);
            }
        });
    }*/
    ...
    public void viewInvoice() {
        ...
        if (row != -1) {
            try {
                ...
                Logger.getLogger(FrameSOAcDocHistory.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }

    public void voidAcDoc() {
        int row = tblInvoice.getSelectedRow();
        if (row != -1) {

            this.acDocs.get(row).setActive(false);
            oAcDocBo.setoAcDoc(this.acDocs.get(row));
   ...
   private class threadVoidAcDoc implements Runnable {

        public threadVoidAcDoc() {
    ...
    private class threadSearchInvoiceByCriteria implements Runnable {

        private int noOfRecord;

        public threadSearchInvoiceByCriteria() {
        }
