 ...
 * @author Yusuf
 */
public class FrameOutstandingPInv3P extends javax.swing.JFrame{
    ...
    public FrameOutstandingPInv3P(java.awt.Frame parent) {
        initComponents();
        startUpThreads();
...
//    }
    ...
    public void searchOutstandingPInvoice() {
        ...
        this.outstandingInvoices = acDocBo.outstandingPInvByCriteria(contactableId, from, to);
    ...
    private void populateTblInvoice(List<PurchaseAccountingDocument> outstandingInvoices) {
        ...
        for (PurchaseAccountingDocument a : outstandingInvoices) {
            ...
            BigDecimal totalCredit = a.getTotalAdm();
            ...
            invoiceModel.insertRow(row, new Object[]{a.getPnr().getGdsPNR(), a.getPnr().getServicingCareer().getCode(),
                        a.getLeadPaxFromTickets(), a.getRecipientRef(), a.getVendorRef(),
    ...
    private void outstandingVendors() {
        ...
        outstandingAgents = acDocBo.outstandingVendors();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(etsbackoffice.ETSBackofficeApp.class).getContext().getResourceMap(FrameOutstandingPInv3P.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(etsbackoffice.ETSBackofficeApp.class).getContext().getActionMap(FrameOutstandingPInv3P.class, this);
        btnViewInvoice.setAction(actionMap.get("viewInvoice")); // NOI18N
        btnViewInvoice.setFont(resourceMap.getFont("jButton1.font")); // NOI18N
        ...
        jButton7.setFont(resourceMap.getFont("jButton1.font")); // NOI18N
        ...
        tblInvoice.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "GDSPNR", "Career", "LeadPax", "RInvRef", "VInvRef", "InvDate", "Terms", "InvFrom", "InvAmount", "CNote", "Paid", "Outstanding"
            }
        ) {
        ...
        tblInvoice.getColumnModel().getColumn(3).setHeaderValue(resourceMap.getString("tblInvoice.columnModel.title11")); // NOI18N
        tblInvoice.getColumnModel().getColumn(4).setHeaderValue(resourceMap.getString("tblInvoice.columnModel.title3")); // NOI18N
        tblInvoice.getColumnModel().getColumn(5).setHeaderValue(resourceMap.getString("tblInvoice.columnModel.title4")); // NOI18N
        tblInvoice.getColumnModel().getColumn(6).setHeaderValue(resourceMap.getString("tblInvoice.columnModel.title5")); // NOI18N
        tblInvoice.getColumnModel().getColumn(7).setHeaderValue(resourceMap.getString("tblInvoice.columnModel.title6")); // NOI18N
        tblInvoice.getColumnModel().getColumn(8).setHeaderValue(resourceMap.getString("tblInvoice.columnModel.title7")); // NOI18N
        tblInvoice.getColumnModel().getColumn(9).setHeaderValue(resourceMap.getString("tblInvoice.columnModel.title8")); // NOI18N
        tblInvoice.getColumnModel().getColumn(10).setHeaderValue(resourceMap.getString("tblInvoice.columnModel.title9")); // NOI18N
        tblInvoice.getColumnModel().getColumn(11).setHeaderValue(resourceMap.getString("tblInvoice.columnModel.title10")); // NOI18N
  ...
  /*  public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new FrameOutstandingPInv3P().setVisible(true);
            }
        });
    }*/
    ...
    private void viewTPInvoice() {
        ...
        if (dlgTPInvoice.showDialog(this.outstandingInvoices.get(row))) {
    ...
    private void viewTPCNote() {
        int row = tblInvoice.getSelectedRow();
        if (!this.outstandingInvoices.get(row).getRelatedDocuments().isEmpty()) {
            DlgTPInvoice dlgTPInvoice = new DlgTPInvoice(this);
            if (dlgTPInvoice.showDialog(this.outstandingInvoices.get(row).getRelatedDocuments().iterator().next())) {
                dlgTPInvoice.dispose();
            } else {
                //new Thread(new threadPurchaseAcDoc(pnr.getPnrId())).start();
            }
