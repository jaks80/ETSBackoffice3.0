 ...
 * @author Yusuf
 */
public class FrameSaleRptWithRevenue extends javax.swing.JFrame{
    ...
    public FrameSaleRptWithRevenue(java.awt.Frame parent) {
        initComponents();       
    ...
    private void searchSales() {
        ...
        if(txtBookingOid.getText().trim().isEmpty()){
        this.boid = null;
        }else{
        this.boid = txtBookingOid.getText();
        }
        ...
        from = dtFrom.getDate();
        to = dtTo.getDate();
        soldTickets = ticketBo.saleReportDetails(ticketingType, gdsId, vendorId, tktStatus, career, from, to,boid);
        populateTblSales();
    }
    ...
    private void populateTblSales() {
        ...
        BigDecimal totalNetFare = new BigDecimal("0.00");
        ...
        for (Ticket t : this.soldTickets) {
            ...
            String invTo = "";
            if(t.getPnr().getAgent()!=null){
            invTo = t.getPnr().getAgent().getName();
            }else if(t.getPnr().getCustomer()!=null){
            invTo = t.getPnr().getCustomer().getFullCustomerName();
            }
            
            totalNetFare = totalNetFare.add(t.getNetFare());
            totalSelling = totalSelling.add(t.getNetPayble());
            totalRev = totalRev.add(t.getTktdRevenue());
            
            salesModel.insertRow(row, new Object[]{row + 1, t.getDocIssuedate(), t.getTktStatusString(),
                        t.getPnr().getGdsPNR(), t.getPnr().getBookingAgtOID(), t.getPnr().getTicketingAgtOID(),"",invTo,
                        ...
                        t.getTotalFare(), t.getBspCom(),fee, t.getNetFare(),t.getNetPayble(),t.getTktdRevenue()});
            row++;
        }
        ...
        BigDecimal totalFare = saleBalance.add(refundBalance).add(comBalance);
        
        salesModel.insertRow(salesModel.getRowCount(), new Object[]{"","","","","","","","","","","Totals",totalIssuedFare.add(totalRefundFare)
                ,totalTax.add(totalTaxRefund),totalFare,comBalance,totalFess,totalNetFare,totalSelling,totalRev});
...
"</html>";
    ...
    org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(etsbackoffice.ETSBackofficeApp.class).getContext().getResourceMap(FrameSaleRptWithRevenue.class);
    ...
    javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(etsbackoffice.ETSBackofficeApp.class).getContext().getActionMap(FrameSaleRptWithRevenue.class, this);
    ...
    txtBookingOid.setFont(resourceMap.getFont("txtBookingOid.font")); // NOI18N
    txtBookingOid.setText(resourceMap.getString("txtBookingOid.text")); // NOI18N
    txtBookingOid.setName("txtBookingOid"); // NOI18N
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 6;
    gridBagConstraints.gridy = 2;
    gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
    gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
    pnlSearch.add(txtBookingOid, gridBagConstraints);
    ...
    tblTicket.setModel(new javax.swing.table.DefaultTableModel(
        ...
        new String [] {
            "", "T.Date", "Status", "PNR", "BookingAgt", "TktingAgt", "InvRef", "Client", "Career", "PaxName", "TktNo", "BaseFare", "Tax", "TotalFare", "BSPCom", "Fee", "NetFare", "NetSelling", "Rev"
        }
    ) {
    ...
    tblTicket.getColumnModel().getColumn(6).setHeaderValue(resourceMap.getString("tblTicket.columnModel.title17")); // NOI18N
    tblTicket.getColumnModel().getColumn(7).setHeaderValue(resourceMap.getString("tblTicket.columnModel.title18")); // NOI18N
    tblTicket.getColumnModel().getColumn(8).setMinWidth(80);
    tblTicket.getColumnModel().getColumn(8).setHeaderValue(resourceMap.getString("tblTicket.columnModel.title6")); // NOI18N
    tblTicket.getColumnModel().getColumn(9).setMinWidth(150);
    tblTicket.getColumnModel().getColumn(9).setMaxWidth(400);
    tblTicket.getColumnModel().getColumn(9).setHeaderValue(resourceMap.getString("tblTicket.columnModel.title7")); // NOI18N
    tblTicket.getColumnModel().getColumn(10).setMinWidth(80);
    tblTicket.getColumnModel().getColumn(10).setHeaderValue(resourceMap.getString("tblTicket.columnModel.title8")); // NOI18N
    tblTicket.getColumnModel().getColumn(11).setMinWidth(80);
    tblTicket.getColumnModel().getColumn(11).setHeaderValue(resourceMap.getString("tblTicket.columnModel.title9")); // NOI18N
    tblTicket.getColumnModel().getColumn(12).setMinWidth(80);
    tblTicket.getColumnModel().getColumn(12).setHeaderValue(resourceMap.getString("tblTicket.columnModel.title10")); // NOI18N
    tblTicket.getColumnModel().getColumn(13).setMinWidth(80);
    tblTicket.getColumnModel().getColumn(13).setHeaderValue(resourceMap.getString("tblTicket.columnModel.title11")); // NOI18N
    tblTicket.getColumnModel().getColumn(14).setMinWidth(80);
    tblTicket.getColumnModel().getColumn(14).setHeaderValue(resourceMap.getString("tblTicket.columnModel.title12")); // NOI18N
    tblTicket.getColumnModel().getColumn(15).setHeaderValue(resourceMap.getString("tblTicket.columnModel.title14")); // NOI18N
    tblTicket.getColumnModel().getColumn(16).setMaxWidth(80);
    tblTicket.getColumnModel().getColumn(16).setHeaderValue(resourceMap.getString("tblTicket.columnModel.title13")); // NOI18N
    tblTicket.getColumnModel().getColumn(17).setHeaderValue(resourceMap.getString("tblTicket.columnModel.title15")); // NOI18N
    tblTicket.getColumnModel().getColumn(18).setHeaderValue(resourceMap.getString("tblTicket.columnModel.title16")); // NOI18N
