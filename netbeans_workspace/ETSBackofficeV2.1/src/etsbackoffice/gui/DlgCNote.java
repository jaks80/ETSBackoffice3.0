 ...
 * @author Yusuf
 */
public class DlgCNote extends javax.swing.JDialog implements ActionListener {
    ...
    public DlgCNote(java.awt.Frame parent) {
        super(parent, "Credit Note", true);
        initComponents();
    ...
    public boolean showCreditNoteDialog(AccountingDocument acDoc) {
        this.acDoc = acDoc;
        lblContactable.setText("Credit Note For");
        ...
        if (close) {
            ...
            acDocLine.setAmount(amount.negate());
    ...
    public boolean showCreditNoteDialog(PurchaseAccountingDocument pAcDoc) {
        this.pAcDoc = pAcDoc;
        lblContactable.setText("Vendor/Credit Note From");
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(etsbackoffice.ETSBackofficeApp.class).getContext().getResourceMap(DlgCNote.class);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(202, 202, 202))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(txtRemark, javax.swing.GroupLayout.DEFAULT_SIZE, 365, Short.MAX_VALUE)
                        .addContainerGap())))
        );
