 ...
 * @author Yusuf
 */
public class DlgApplyCredit extends javax.swing.JDialog implements ActionListener{
    ...
    private List<AccountingDocument> outstandingRefunds = new ArrayList<AccountingDocument>();
    ...
    public DlgApplyCredit(DlgTInvoice parent)  {
        super(parent, "Apply Credit", true);
        initComponents();
        btnDone.addActionListener(this);
    }

    public DlgApplyCredit(java.awt.Frame parent) {
        super(parent, "Apply Credit", true);
        initComponents();
        btnDone.addActionListener(this);
    }
    ...
    private void populateInvoice() {
        ...
        lblAcDocRef.setText(this.acDoc.getAcDocRefString());
        lblIssueDate.setText(df.dateForGui(this.acDoc.getIssueDate()));
        lblAcDocFor.setText(this.acDoc.getAcDocFor());
    ...
    private void populateTblInvoice() {
        ...
        for (AccountingDocument a : outstandingRefunds) {

            invoiceModel.insertRow(row, new Object[]{a.getAcDocRef(), a.getIssueDate(), a.getPnr().getServicingCareer().getCode(),
    ...
    public boolean showDlgApplyCredit(AccountingDocument invoice) {
        this.acDoc = invoice;
        populateInvoice();
        ...
        for (AccountingDocument currentCNote : invoice.getRelatedDocuments()) {
            ...
            if (remainingAmount.compareTo(outstandingAmount) < 0) {
                ...
                t.setTransRef("Credit transfer from : " + invoice.getAcDocRef() + " to " + this.acDoc.getAcDocRef());
                t.setActive(true);
    ...
    public List<AcTransaction> applyCredit(List<AcTransaction> acts) {
        List<AcTransaction> newTrans = new ArrayList();

        for (AcTransaction t : acts) {
            AcTransaction newT = new AcTransaction();
            newT.setTransDate(t.getTransDate());
            newT.setPnr(this.acDoc.getPnr());            
            newT.setUser(AuthenticationBo.getLoggedOnUser());
            newT.setAccountingDocument(this.acDoc);
            newT.setInvoice(this.acDoc);
            newT.setTransType(8);//Ac Adjustment
            newT.setTransRef(t.getTransRef());
            newT.setActive(true);
            newT.addAcStatement(accountsBo.newAccountsTransactionFromSAcTransaction(newT));
    ...
    public void submitTransactoin() {
        ...
        List<AcTransaction> trans = new ArrayList();
        ...
        acTransactionBo.saveBulkACTransaction(trans);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(etsbackoffice.ETSBackofficeApp.class).getContext().getResourceMap(DlgApplyCredit.class);
        ...
        lblAcDocFor.setFont(resourceMap.getFont("jLabel6.font")); // NOI18N
        lblAcDocFor.setText(resourceMap.getString("lblAcDocFor.text")); // NOI18N
        lblAcDocFor.setName("lblAcDocFor"); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(lblAcDocFor, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private class threadOutstandingRefundCompact implements Runnable {
        ...
        public void run() {
            System.out.println("ID: "+acDoc.getPnr().getContactableId());
            outstandingRefunds = acDocBo.outstandingCNote(acDoc.getPnr().getContactableId(), acDoc.getPnr().getContactableType(), null, null);
            populateTblInvoice();
        }
    }
}
