...
import com.ets.fe.acdoc.model.AccountingDocumentLine;
...
public class OtherServiceComp extends javax.swing.JPanel implements PropertyChangeListener {
    ...
    public OtherServiceComp(JDialog parent) {
        this.parent = parent;
        initComponents();
    }
    ...
    private void populatetblInvLine() {
        ...
        servicesModel.addTableModelListener(new TableModelListener() {
    ...
    private ActionListener cmbServicesListener = (ActionEvent e) -> {
