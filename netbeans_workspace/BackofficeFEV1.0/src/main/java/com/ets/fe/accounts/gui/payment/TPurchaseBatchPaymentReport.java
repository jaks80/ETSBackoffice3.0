...
public class TPurchaseBatchPaymentReport extends javax.swing.JInternalFrame implements PropertyChangeListener {
    ...
    private void search() {
        ...
        task = new ReceiptTask(Enums.ClientType.AGENT, client_id, from, to, Enums.SaleType.TKTPURCHASE, progressBar);
    ...
    private void populateTblPayment() {
        ...
        if (payments.size() > 0) {
            for (int i = 0; i < payments.size(); i++) {
                ...
                tableModel.insertRow(i, new Object[]{p.getPaymentDate(), p.getPaymentType(), p.getTotalAmount(), p.getRemark(), p.getCashier()});
            }
        } else {
            tableModel.insertRow(0, new Object[]{"", ""});
        }

        if(tblPayment.getRowCount()>selectedRow){
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addContainerGap())
                    .addComponent(documentSearchComponent, javax.swing.GroupLayout.DEFAULT_SIZE, 207, Short.MAX_VALUE)))
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addComponent(tabResult, javax.swing.GroupLayout.DEFAULT_SIZE, 763, Short.MAX_VALUE)
        );
    ...
    private void report(String action) {
        ...
        if (index != -1) {
            ...
            report.transactionReceipt(collection, Enums.SaleType.TKTPURCHASE, action);
        } else {
