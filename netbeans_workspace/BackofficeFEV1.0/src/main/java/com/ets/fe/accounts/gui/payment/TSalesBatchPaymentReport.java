 ...
 * @author Yusuf
 */
public class TSalesBatchPaymentReport extends javax.swing.JInternalFrame implements PropertyChangeListener {
    ...
    public TSalesBatchPaymentReport(JDesktopPane desktopPane) {
    ...
    private void populatePaymentDocuments(TransactionReceipt payment) {
        ...
        List<TktingInvoiceSummery> docs = payment.getLines();
        BigDecimal total = new BigDecimal("0.00");
        int i = 0;
        if (docs.size() > 0) {
            for (; i < docs.size(); i++) {
                TktingInvoiceSummery doc = docs.get(i);
        ...
        tblPaymentDocs.getColumnModel().getColumn(5).setMinWidth(0);
        tblPaymentDocs.getColumnModel().getColumn(5).setMaxWidth(0);
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("History: Sales Payment");
        ...
        jLabel7.setText("Sales Payment History");
        ...
        if (tblPaymentDocs.getColumnModel().getColumnCount() > 0) {
            ...
            tblPaymentDocs.getColumnModel().getColumn(3).setMinWidth(60);
            tblPaymentDocs.getColumnModel().getColumn(3).setPreferredWidth(60);
            tblPaymentDocs.getColumnModel().getColumn(3).setMaxWidth(60);
            tblPaymentDocs.getColumnModel().getColumn(5).setMinWidth(40);
            tblPaymentDocs.getColumnModel().getColumn(5).setPreferredWidth(40);
            tblPaymentDocs.getColumnModel().getColumn(5).setMaxWidth(40);
        }
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addComponent(tabResult, javax.swing.GroupLayout.DEFAULT_SIZE, 808, Short.MAX_VALUE)
        );
        jPanel2Layout.setVerticalGroup(
            jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(tabResult, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 472, Short.MAX_VALUE)
        );
    ...
    private void btnEmailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEmailActionPerformed
        ...
        if (index != -1) {
            ...
            if (receipent != null) {
                ...
                list.add(receipt);
                jasperreport.transactionReceipt(list, Enums.SaleType.TKTSALES, "EMAIL");
            } else {
    ...
    private void report(String action) {
        ...
        if (index != -1) {
            ...
            JRViewer viewer = jasperreport.transactionReceipt(list, Enums.SaleType.TKTSALES, action);
            if (viewer != null) {
