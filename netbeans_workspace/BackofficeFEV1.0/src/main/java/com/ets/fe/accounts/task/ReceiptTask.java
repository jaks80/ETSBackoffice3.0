 ...
 * @author Yusuf
 */
public class ReceiptTask extends SwingWorker<TransactionReceipts, Integer> {
    ...
    public ReceiptTask(Enums.ClientType clienttype, Long clientid, Date dateFrom, Date dateTo, Enums.SaleType saleType, JProgressBar progressBar) {
    ...
    @Override
    protected TransactionReceipts doInBackground() throws Exception {
